...
class UnetGeneratorB2A(nn.Module):
    ...
    def forward(self, lf, img):
        ...
        return None, up_2, self.shallow(torch.cat([up_2, lf_input], 1)) # B2A: hf_feature, lf_feature, rc
...
class UnetGeneratorA2B(nn.Module):
    ...
    def forward(self, hf, img):
        ...
        input = self.shallow_frequency(hf)

        hf_input = self.shallow_frequency(img)# (64, 160)
        ...
        return None, hf_input, self.shallow(torch.cat([up_1, input], 1)) # A2B: lf_feature, hf_feature, rc
